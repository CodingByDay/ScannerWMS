...
namespace ScannerQR.App
{
    ...
    class IssuedEnteredPositionsViewAdapter : BaseAdapter
    {
        public List<TakeOverEnteredPositionsViewListItems> sList;
        private Context sContext;
        public IssuedEnteredPositionsViewAdapter(Context context, List<TakeOverEnteredPositionsViewListItems> list)
        {
            sList = list;
            sContext = context;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            try
            {
                if (row == null)
                {
                    row = LayoutInflater.From(sContext).Inflate(Resource.Layout.IssuedEnteredPositionsViewList, null, false);
                }
